...
namespace DG.DOTweenEditor
{
    ...
    public class DOTweenAnimationInspector : ABSAnimationInspector
    {
        ...
        static readonly Dictionary<MyDOTweenAnimationType, Type[]> _AnimationTypeToComponent = new Dictionary<MyDOTweenAnimationType, Type[]>() {
            { MyDOTweenAnimationType.Move, new[] { typeof(Rigidbody), typeof(Rigidbody2D), typeof(RectTransform), typeof(Transform) } },
            { MyDOTweenAnimationType.LocalMove, new[] { typeof(RectTransform), typeof(Transform) } },
            { MyDOTweenAnimationType.Rotate, new[] { typeof(Rigidbody), typeof(Rigidbody2D), typeof(Transform) } },
            { MyDOTweenAnimationType.LocalRotate, new[] { typeof(Transform) } },
            { MyDOTweenAnimationType.Scale, new[] { typeof(Transform) } },
            { MyDOTweenAnimationType.Color, new[] { typeof(SpriteRenderer), typeof(Renderer), typeof(Image), typeof(Text), typeof(Light) } },
            { MyDOTweenAnimationType.Fade, new[] { typeof(SpriteRenderer), typeof(Renderer), typeof(Image), typeof(Text), typeof(CanvasGroup), typeof(Light) } },
            { MyDOTweenAnimationType.Text, new[] { typeof(Text) } },
            { MyDOTweenAnimationType.PunchPosition, new[] { typeof(RectTransform), typeof(Transform) } },
            { MyDOTweenAnimationType.PunchRotation, new[] { typeof(Transform) } },
            { MyDOTweenAnimationType.PunchScale, new[] { typeof(Transform) } },
            { MyDOTweenAnimationType.ShakePosition, new[] { typeof(RectTransform), typeof(Transform) } },
            { MyDOTweenAnimationType.ShakeRotation, new[] { typeof(Transform) } },
            { MyDOTweenAnimationType.ShakeScale, new[] { typeof(Transform) } },
            { MyDOTweenAnimationType.CameraAspect, new[] { typeof(Camera) } },
            { MyDOTweenAnimationType.CameraBackgroundColor, new[] { typeof(Camera) } },
            { MyDOTweenAnimationType.CameraFieldOfView, new[] { typeof(Camera) } },
            { MyDOTweenAnimationType.CameraOrthoSize, new[] { typeof(Camera) } },
            { MyDOTweenAnimationType.CameraPixelRect, new[] { typeof(Camera) } },
            { MyDOTweenAnimationType.CameraRect, new[] { typeof(Camera) } },
            { MyDOTweenAnimationType.UIWidthHeight, new[] { typeof(RectTransform) } },
            { MyDOTweenAnimationType.UGUIFillAmount, new[] { typeof(Image) } },

        };

#if DOTWEEN_TK2D
        static readonly Dictionary<MyDOTweenAnimationType, Type[]> _Tk2dAnimationTypeToComponent = new Dictionary<MyDOTweenAnimationType, Type[]>() {
            { MyDOTweenAnimationType.Color, new[] { typeof(tk2dBaseSprite), typeof(tk2dTextMesh) } },
            { MyDOTweenAnimationType.Fade, new[] { typeof(tk2dBaseSprite), typeof(tk2dTextMesh) } },
            { MyDOTweenAnimationType.Text, new[] { typeof(tk2dTextMesh) } }
        };
#endif
#if DOTWEEN_TMP
        static readonly Dictionary<MyDOTweenAnimationType, Type[]> _TMPAnimationTypeToComponent = new Dictionary<MyDOTweenAnimationType, Type[]>() {
            { MyDOTweenAnimationType.Color, new[] { typeof(TextMeshPro), typeof(TextMeshProUGUI) } },
            { MyDOTweenAnimationType.Fade, new[] { typeof(TextMeshPro), typeof(TextMeshProUGUI) } },
            { MyDOTweenAnimationType.Text, new[] { typeof(TextMeshPro), typeof(TextMeshProUGUI) } }
        };
#endif
        ...
        override public void OnInspectorGUI()
        {
            ...
            GUILayout.BeginHorizontal();
            MyDOTweenAnimationType prevAnimType = _src.animationType;
            //                _src.animationType = (MyDOTweenAnimationType)EditorGUILayout.EnumPopup(_src.animationType, EditorGUIUtils.popupButton);
            ...
            _src.animationType = AnimationToMyDOTweenAnimationType(_AnimationType[EditorGUILayout.Popup(MyDOTweenAnimationTypeToPopupId(_src.animationType), _AnimationType)]);
            ...
            if (prevAnimType != _src.animationType)
            {
                ...
                {
                    case MyDOTweenAnimationType.Move:
                    case MyDOTweenAnimationType.LocalMove:
                    case MyDOTweenAnimationType.Rotate:
                    case MyDOTweenAnimationType.LocalRotate:
                    case MyDOTweenAnimationType.Scale:
                    case MyDOTweenAnimationType.UGUIFillAmount:
                        _src.endValueV3 = Vector3.zero;
                        _src.endValueFloat = 0;
                        _src.optionalBool0 = _src.animationType == MyDOTweenAnimationType.Scale;
                        break;
                    case MyDOTweenAnimationType.UIWidthHeight:
                        _src.endValueV3 = Vector3.zero;
                        _src.endValueFloat = 0;
                        _src.optionalBool0 = _src.animationType == MyDOTweenAnimationType.UIWidthHeight;
                        break;
                    case MyDOTweenAnimationType.Color:
                    case MyDOTweenAnimationType.Fade:
                        _isLightSrc = _src.GetComponent<Light>() != null;
                        _src.endValueFloat = 0;
                        break;
                    case MyDOTweenAnimationType.Text:
                        _src.optionalBool0 = true;
                        break;
                    case MyDOTweenAnimationType.PunchPosition:
                    case MyDOTweenAnimationType.PunchRotation:
                    case MyDOTweenAnimationType.PunchScale:
                        _src.endValueV3 = _src.animationType == MyDOTweenAnimationType.PunchRotation ? new Vector3(0, 180, 0) : Vector3.one;
                        _src.optionalFloat0 = 1;
                        _src.optionalInt0 = 10;
                        _src.optionalBool0 = false;
                        break;
                    case MyDOTweenAnimationType.ShakePosition:
                    case MyDOTweenAnimationType.ShakeRotation:
                    case MyDOTweenAnimationType.ShakeScale:
                        _src.endValueV3 = _src.animationType == MyDOTweenAnimationType.ShakeRotation ? new Vector3(90, 90, 90) : Vector3.one;
                        _src.optionalInt0 = 10;
                        _src.optionalFloat0 = 90;
                        _src.optionalBool0 = false;
                        break;
                    case MyDOTweenAnimationType.CameraAspect:
                    case MyDOTweenAnimationType.CameraFieldOfView:
                    case MyDOTweenAnimationType.CameraOrthoSize:
                        _src.endValueFloat = 0;
                        break;
                    case MyDOTweenAnimationType.CameraPixelRect:
                    case MyDOTweenAnimationType.CameraRect:
                        _src.endValueRect = new Rect(0, 0, 0, 0);
                        break;
                }
            }
            if (_src.animationType == MyDOTweenAnimationType.None)
            {
                _src.isValid = false;
            ...
            if (prevAnimType != _src.animationType || ComponentsChanged())
            {
                ...
                if (_src.animationType == MyDOTweenAnimationType.Fade && _src.GetComponent<CanvasGroup>() != null && _src.GetComponent<Image>() != null)
                {
            ...
            switch (_src.animationType)
            {
                case MyDOTweenAnimationType.Move:
                case MyDOTweenAnimationType.LocalMove:
                    GUIEndValueV3(_src.animationType == MyDOTweenAnimationType.Move);
                ...
                case MyDOTweenAnimationType.PunchScale:
                    ...
                    if (_src.animationType == MyDOTweenAnimationType.PunchPosition) _src.optionalBool0 = EditorGUILayout.Toggle("    Snapping", _src.optionalBool0);
                    break;
                case MyDOTweenAnimationType.ShakePosition:
                case MyDOTweenAnimationType.ShakeRotation:
                case MyDOTweenAnimationType.ShakeScale:
                    ...
                    if (_src.animationType == MyDOTweenAnimationType.ShakePosition) _src.optionalBool0 = EditorGUILayout.Toggle("    Snapping", _src.optionalBool0);
                    break;
                case MyDOTweenAnimationType.CameraAspect:
                case MyDOTweenAnimationType.CameraFieldOfView:
                case MyDOTweenAnimationType.CameraOrthoSize:
                    ...
                    canBeRelative = false;
                    break;
                case MyDOTweenAnimationType.CameraBackgroundColor:
                    GUIEndValueColor();
                    canBeRelative = false;
                    break;
                case MyDOTweenAnimationType.CameraPixelRect:
        ...
        bool Validate()
        {
            if (_src.animationType == MyDOTweenAnimationType.None) return false;
        ...
        MyDOTweenAnimationType AnimationToMyDOTweenAnimationType(string animation)
        {
            if (_datString == null) _datString = Enum.GetNames(typeof(MyDOTweenAnimationType));
            animation = animation.Replace("/", "");
            return (MyDOTweenAnimationType)(Array.IndexOf(_datString, animation));
        }
        int MyDOTweenAnimationTypeToPopupId(MyDOTweenAnimationType animation)
        {
