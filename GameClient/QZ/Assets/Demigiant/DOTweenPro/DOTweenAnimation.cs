...
{
    public enum MyDOTweenAnimationType
    {
        None = 0,
        Move = 1,
        LocalMove = 2,
    ...
    public class DOTweenAnimation : ABSAnimationComponent
    {
        ...
        public MyDOTweenAnimationType animationType;
        ...
        void Awake()
        {
            ...
            if (animationType != MyDOTweenAnimationType.Move || !useTargetAsV3)
            {
        ...
        public void CreateTween()
        {
            ...
            {
                case MyDOTweenAnimationType.None:
                    break;
                ...
                case MyDOTweenAnimationType.LocalMove:
                    ...
                    //RectTransform _targetType = target.transform as RectTransform;
                    //if (_targetType != null) targetType = TargetType.RectTransform;
                    ...
                    //        tween = DOTween.To(() => rect.anchoredPosition3D, x => rect.anchoredPosition3D = x, endValueV3, duration);
                ...
                case MyDOTweenAnimationType.UGUIFillAmount:
                    ...
                    tween = DOTween.To(() => image.fillAmount, x => image.fillAmount = x, endValueFloat, duration);
                    break;
        ...
        {
            if (animationType == MyDOTweenAnimationType.Move)
            {
                ((Tweener)tween).ChangeEndValue(transform.position + endValueV3, true);
            }
            else if (animationType == MyDOTweenAnimationType.LocalMove)
            {
